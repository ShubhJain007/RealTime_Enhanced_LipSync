...
class Avatar:
    ...
    def process_frames(self, 
                       res_frame_queue,
                       video_len,
                       skip_save_images, audio_path): ##added audio_path
        print(video_len)
        rtmp_url = "rtmp://172.23.2.104/live/stream"
    ...
    # Start FFmpeg process
        ffmpeg_process = subprocess.Popen(
            [
                ...
                "-f", "rawvideo",
                "-pix_fmt", "bgr24",
                "-s", "1620x1080",  # Match video frame size
                "-r", "30",
                ...
                # Ensure synchronization of audio and video
                "-shortest",  # Stops when the shorter stream ends
                "-c:v", "libx264",
                "-preset", "ultrafast",
                "-tune", "zerolatency",
                "-f", "flv", rtmp_url
        ...
        while True:
            ...
            print(f"Frame shape: {combine_frame.shape}, dtype: {combine_frame.dtype}")
            ffmpeg_process.stdin.write(combine_frame.tobytes())
    ...
    def inference(self, 
        ...
        process_thread = threading.Thread(target=self.process_frames, args=(res_frame_queue, video_num, skip_save_images, audio_path)) #added audio path
